    ...
    <div className="text-left bg-gray-200 p-6 pr-12 text-center relative w-screen h-screen overflow-hidden">
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-600 mt-2 mx-5">
          ...
          been dedicated to crafting seamless and magical experiences, whether
          it's your dream wedding, a mesmerizing holiday, or a stunning event.
          Our founder, Ms. Shree Kurup, envisioned a company that goes beyond
          traditional event planning. With a passion for curating unique and
          personalized experiences, she has led Devshree to become a name
        ...
        <p className="text-gray-600 mt-2 mx-5 ">
          ...
          vision to bring your dreams to life. We believe that every event is a
